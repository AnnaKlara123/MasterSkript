...
parser.add_argument('--lapsrate', type=str, help='The lapsrate that should be used', default="6.5")  # not working yet!
...
lapse_rate = args.lapsrate  # degrees per 1000m
adj_factor = 1 - (lapse_rate * alt_diff / 1000)
print ("Adjustmentfactor: 1 - (lapse_rate * altitude_difference / 1000) =",adj_factor)
