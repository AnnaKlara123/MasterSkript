...
class File:
    ...
    def replace_nan(self):
        ...
        # # For Precipitation datasets use following code as well to exclude Data Values higher than 45
        self.df['Stat1'] = self.df['Stat1'].apply(lambda x: x if x <= -40 and x != -777 else float("NaN"))
