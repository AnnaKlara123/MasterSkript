...
parser.add_argument('--height1', type=str, help='The Dataframe 1 height ', default="1587")
parser.add_argument('--df2', type=str, help='The Dataframe 2 DF with higher frequency', default= 'Precipitation_NaN_Test.csv')
parser.add_argument('--height2', type=str, help='The Dataframe 2 height ', default="2141")
